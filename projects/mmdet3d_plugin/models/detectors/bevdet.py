...
class BEVDet(CenterPoint):
    ...
    def image_encoder(self, img, stereo=False):
        ...
        # print('in the image encoder shape is: ', imgs.shape)
    ...
    def bev_encoder(self, x):
        ...
        Returns:
            x: (B, C', 2*Dy, 2*Dx)
        """
        # print('in the bev encoder is: ', x.size())
    ...
    def extract_img_feat(self, img_inputs, img_metas, **kwargs):
        ...
        # print('feature after backbone is: {}'.format(x.size()))
        x, depth = self.img_view_transformer([x] + img_inputs[1:7])
        # print('img_view_transformer outputsis: ', x.size(), depth.size())
        # x: (B, C, Dy, Dx)
        # depth: (B*N, D, fH, fW)
