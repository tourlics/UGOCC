...
optimizer = dict(type='AdamW', lr=1.3e-4, weight_decay=1e-2)
...
load_from = './paper_used_models/waymo2nuscenes/FlashOcc/epoch_22_ema.pth'
# load_from = './domain_adaptation_work_dirs/nuscenes_nine_label/2dbaseline/nusc_2dbaseline_depthfusion_2_42_0.5_backbone_res50_img256_704_without_transformer/epoch_25_ema.pth'