...
class BEVDet4D(BEVDet):
    ...
    def extract_img_feat(self,
        ...
        """
        print('if sequential: ', sequential)
        if sequential:
        ...
        print('what is this:  self.with_prev', self.with_prev, 'and type of img is: {}'.format(type(imgs)), len(imgs))
        ...
        print('bev_feat_list is: ', [i.size() for i in bev_feat_list])
