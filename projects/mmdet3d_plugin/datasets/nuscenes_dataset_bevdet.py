...
class NuScenesDatasetBEVDet(Custom3DDataset):
    ...
    def get_data_info(self, index):
        ...
        # print('here we debug the nuscenes det dataset, after adj_list is: {}, {}'.format(type(input_dict),
        #                                                                                   input_dict.keys()))
        #
        # print(' I want the info keys is: ', info.keys(), info['scene_token'])
        # print('timestamp: ', input_dict['timestamp'])
        # print('occ_gt_path: is is is is is is is: ', info['occ_path'])
        return input_dict
