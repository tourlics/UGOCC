...
load_from = './work_dirs/nusc_2d_head_baseline_img256_704_200_200_16_res101_depth2_42_0.5/epoch_20_ema.pth'
# load_from = "work_dirs/nusc_2d_head_baseline_img256_704_200_200_16_res50_depth2_42_0.5/latest.pth"
...
# ===> bus - IoU = 37.77
# ===> car - IoU = 38.62
# ===> construction_vehicle - IoU = 18.61
# ===> motorcycle - IoU = 21.84
# ===> pedestrian - IoU = 22.2
# ===> traffic_cone - IoU = 23.01
# ===> trailer - IoU = 27.41
# ===> truck - IoU = 30.76
# ===> driveable_surface - IoU = 65.67
# ===> other_flat - IoU = 38.65
# ===> sidewalk - IoU = 40.01
# ===> terrain - IoU = 36.51
# ===> manmade - IoU = 19.7
# ===> vegetation - IoU = 19.91
# ===> mIoU of 6019 samples: 29.93
# {'mIoU': array([0.109, 0.37 , 0.203, 0.378, 0.386, 0.186, 0.218, 0.222, 0.23 ,
#        0.274, 0.308, 0.657, 0.386, 0.4  , 0.365, 0.197, 0.199, 0.833])}
