...
class BEVDepth(BEVDet):
    ...
    def extract_img_feat(self, img_inputs, img_metas, **kwargs):
        ...
        # print('test imgs {}, sensor2keyegos {}, ego2globals {}, intrins {}, post_rots {}, post_trans {}, bda {}'.format(
    ...
    def forward_test(self,
        ...
        """
        # print('length of img_inputs is: ', len(img_inputs), len(img_inputs[0]), type(img_metas[0]))
