...
model = dict(
    ...
    # SemQueryModule=dict(
    #     type='SEMAtention_Fusion_Module',
    #     semantic_decoder=dict(
    #         type='SeSemanticDecoder',
    #         semantic_attention=dict(
    #             type='SemanticAttention',
    #             emb_dim=numC_Trans,
    #             n_cls=num_classes
    #         ),
    #         def_attention=dict(
    #             type='SeMultiHeadAttention',
    #             embed_dims=numC_Trans,
    #             num_heads=8
    #         )
    #     ),
    #
    #     bev_h=int((grid_config['x'][1] - grid_config['x'][0]) / grid_config['x'][2]),
    #     bev_w=int((grid_config['y'][1] - grid_config['y'][0]) / grid_config['y'][2]),
    ...
    #         num_feats=40,
    #         row_num_embed=int((grid_config['x'][1] - grid_config['x'][0]) / grid_config['x'][2]),
    #         col_num_embed=int((grid_config['y'][1] - grid_config['y'][0]) / grid_config['y'][2]),
    #     ),
    #     transformer=dict(
    #         type='SEMFormer',
    #         num_cams=waymo_data_config['Ncams'],
    ...
    #                         num_levels=1),
    #                     dict(
    #                         type='SEM_SpatialCrossAttention',
    #                         num_cams=waymo_data_config['Ncams'],
    #                         pc_range=point_cloud_range,
    #                         dbound=grid_config['depth'],
    #                         dropout=0.0,
    #                         deformable_attention=dict(
    #                             type='SAMDEPTH_AWARE_MSDeformableAttention',
    #                             embed_dims=numC_Trans,
    #                             num_points=8,
    #                             num_levels=1),
    #                         embed_dims=numC_Trans,
...
# load_from = './domain_adaptation_work_dirs/pretrain_depth/pretrained_self_supervised_depth_estimation_1-61-0.5_cvt_based_with_occ2/epoch_24_ema.pth'
load_from = None
