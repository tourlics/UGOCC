...
def disp_to_depth(disp, min_depth, max_depth, abs = True):
    """Convert network's sigmoid output into depth prediction
    The formula for this conversion is given in the 'additional considerations'
    section of the paper.

    discussion： https://github.com/AutoAILab/FusionDepth/issues/19

    monodepth2:
    https://github.com/nianticlabs/monodepth2/issues/315

    https://github.com/nianticlabs/monodepth2/issues/47
