...
class SemiSSdDepthSamBaseline(BaseModule):
    def __init__(self,
                 rendernet=None,
                 backproj=None,
                 Backbone=None,
    ...
    def forward_train(self,
        ...
        sem_score = self.semantic_head(context, pred_depth)
        loss_sem_map = self.semantic_head.loss(sem_score, gt_semantic_label)
...
def save_semantic_depth_img_mask_occ(img_map, pred_depth_map, gt_sem_map, mask_camera,
                                     ...
                                     out_dir=None, forward_save=False):
