...
class OccEncoder(TransformerLayerSequence):
    ...
    def __init__(self, *args, pc_range=None, return_intermediate=False, grid_config=None, data_config=None, dataset_type='nuscenes',
                 fix_bug=False, **kwargs):
    ...
    def point_sampling(self, reference_points, cam_params=None):
        ...
        print('sdadasd: ', reference_points[None, None].size(), reference_points.size())
        ...
        print('in the point sampling ++++++++++++', reference_points_cam.size())
        ...
        print('fivder after is: ', reference_points_cam.size())
        ...
        print('sttttL: ', reference_points_cam.size())
        reference_points_cam = reference_points_cam.permute(1, 0, 2, 3, 4, 5).reshape(N, B, H * W*D, 1, 3)
        mask = mask.permute(1, 0, 2, 3, 4, 5).reshape(N, B, H * W * D, 1)
        print('ref_points camis: ', reference_points_cam.size(), 'and mask size is: ', mask.size())
    ...
    def forward(self,
        ...
        print('volume query size is: ', volume_query.size())
