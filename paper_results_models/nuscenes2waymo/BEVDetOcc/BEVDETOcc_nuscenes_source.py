...
optimizer = dict(type='AdamW', lr=1e-6, weight_decay=1e-2)
...
# load_from = './paper_used_models/nuscenes2waymo/BEVDetOcc/nuscenes_source_train_iter_based.pth'
load_from = './paper_used_models/waymo2nuscenes/BEVDetOcc/BEVDETOcc_waymo_source_only.pth'